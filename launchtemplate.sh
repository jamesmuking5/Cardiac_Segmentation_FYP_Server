...
export ECR_REGISTRY_URI="004078809023.dkr.ecr.ap-southeast-1.amazonaws.com"
export ECR_REPOSITORY_NAME="cardiac_segmentation_fyp_server"
...
export AWS_BUCKET_NAME="visheart-bucket-ap-southeast-1"
