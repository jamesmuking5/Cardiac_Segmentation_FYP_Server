...
// SECURITY: Validate that SESSION_SECRET is properly configured
if (!process.env.SESSION_SECRET) {
  throw new Error("SESSION_SECRET environment variable is required for security. Please set it in your .env file.");
}
